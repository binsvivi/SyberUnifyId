...
//import com.syber.internal.widget.LockPatternUtils;

import com.star.lockpattern.widget.LockPatternIndicator;
import com.star.lockpattern.widget.LockPatternView;
//import com.syber.internal.widget.LockPatternView;
	...
	private void updateStatus(Status status, List<LockPatternView.Cell> pattern) {
		...
		switch (status) {
			...
			case CONFIRMCORRECT:
				...
				Intent intent = new Intent(getApplicationContext(), StudySettingActivity.class);
				startActivity(intent);
				finish();
				break;
		}
