...
//import com.syber.internal.widget.SyberLockPatternView;
import com.syber.internal.widget.*;
...
public class LockPatternUtil {
     ...
     */
    public static byte[] patternToHash(List<SyberLockPatternView.Cell> pattern) {
        if (pattern == null) {
            return null;
        } else {
